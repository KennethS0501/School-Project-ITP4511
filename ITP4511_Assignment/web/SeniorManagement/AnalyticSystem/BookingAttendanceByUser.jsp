        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                    ...
                    <form>
                        <div class="field"><select class="form-control" style="width: 165px;"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select>
                            <label
                    ...
                    <form>
                        <div class="field"><select class="form-control" style="width: 163px;"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select>
                            <label
...
<label>User name:</label> <label>K</label><br/>
<label>Total Approve Booking: </label> <label>123</label><br/>
<label>Present Booking: </label> <label>112</label><br/>
<label>Absent Booking: </label> <label>13</label><br/>
<label>Booking attendance rate: </label> <label>123*13*100%</label>
