...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/Community-ChatComments.css">
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/dash-1.css">
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/Google-Style-Login.css">
        ...
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/select.css">
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/styles.css">
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/Table-with-search.css">
    </head>
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-12" style="margin-left: 99px;">
                                <div class="list-group">
                                    <a class="list-group-item list-group-item-action" data-toggle="list" onclick="window.location.href = '<%=request.getContextPath() %>/SeniorManagement/Account.jsp';" style="width: 250px;height: 49px;">Account Details</a>
                                    <a class="list-group-item list-group-item-action" data-toggle="list" onclick="window.location.href = '<%=request.getContextPath() %>/SeniorManagement/AccountManagement/AccountManagement.jsp';" style="width: 250px;">Account Management</a>
                                    <a class="list-group-item list-group-item-action" data-toggle="list" onclick="window.location.href = '<%=request.getContextPath() %>/SeniorManagement/AnalyticSystem/AnalyticManagement.jsp';" style="width: 250px;">Analytic System</a>
                                    <a class="list-group-item list-group-item-action" data-toggle="list" onclick="window.location.href = '<%=request.getContextPath() %>/SeniorManagement/RoleManagement/RoleManagement.jsp';" style="width: 250px;">Role Management</a></div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="card rounded shadow border-0">
                                            <div class="card-body p-5 bg-white rounded">
                                                <dl class="row">
                                                    ...
                                                    <dd class="col-sm-9"><jsp:getProperty name="userInfo" property="role" /></dd>
                                                </dl>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="<%=request.getContextPath() %>/assets/js/Gruntfile.js"></script>
        <script src="<%=request.getContextPath() %>/assets/js/jquery-3.6.4.min.js"></script>
        <script src="<%=request.getContextPath() %>/assets/js/jquery.maphilight.min.js"></script>
        <script src="<%=request.getContextPath() %>/assets/js/Table-with-search.js"></script>
    </body>
