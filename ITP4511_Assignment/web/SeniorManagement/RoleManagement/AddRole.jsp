            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                    <div style="text-align:center;">
                        <h2 class="divider-style" style="margin-top: -1px;"><span>Add Role<br></span></h2>
...
<div class="container py-0">
  ...
  <dt class="col-sm-12" style="font-size: 18px;">Role Name:</dt>
    <dd class="col-sm-12" style="font-size: 20px;"><input type="text"></dd>
    
<button class="btn btn-primary" data-toggle="modal" data-target="#modal1" type="button" style="margin-left:42%; margin-right:40%; width:100px; height: 40px; font-size: 18px; margin-top: 20px"><b>Add</b></button>
        </div>
