...
<body>
    ...
    <div class="login-card">
        <form class="form-signin"><span class="reauth-email"> </span><input class="form-control" type="email" id="inputName" required="" placeholder="Name" autofocus=""><input class="form-control" type="email" id="inputEmail" required="" placeholder="Email address" autofocus="">
            <input
                class="form-control" type="email" id="inputPwd" required="" placeholder="Password" autofocus=""><input class="form-control" type="password" id="inputCofirmPwd" required="" placeholder="Confirm Password">
                <div class="checkbox"></div><button class="btn btn-primary btn-block btn-lg btn-signin" type="submit">Register</button></form>
    </div>
