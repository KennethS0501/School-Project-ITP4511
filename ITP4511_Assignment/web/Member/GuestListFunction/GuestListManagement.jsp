            ...
            <div class="container">
                ...
                <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                    <div style="text-align:center;">
                        <h2 class="divider-style" style="margin-top: -1px;"><span>Guest List Management<br></span></h2>
                    </div>
                    <div class="card">
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Guest List Details</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>1. Check guest list</strong><br><strong>2. Add guest to guest list</strong><br><strong>3. Edit guest from guest list</strong><br><strong>4. Delete guest from guest list</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" type="submit" style="width: 94px;" onclick="window.location.href = 'GuestList.jsp';" ><strong>Go</strong><br></button>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Create Guest List</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Create a new guest list</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" type="submit" style="width: 94px;" onclick="window.location.href = 'CreateGuestList.jsp';" ><strong>Go</strong><br></button>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Edit Guest List</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Edit guest list name</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" type="submit" style="width: 94px;" onclick="window.location.href = 'EditGuestList.jsp';" ><strong>Go</strong><br></button>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Delete Guest List</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Delete selected guest list</strong><br></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" type="submit" style="width: 94px;" onclick="window.location.href = 'DeleteGuestList.jsp';" ><strong>Go</strong><br></button>
                        </div>
                    </div>
                </div>
            </div>
