                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span>Upload Payment Receipt<br></span></h2>
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <bookingRecords:showBookingRecord memberId="${userInfo.getId()}" tagType="ShowConfirmByTable" />
                            </tbody>
                        </table>
                        <h2 class="divider-style" style="margin-top: -1px;text-align: center;"><span>Upload Payment Receipt<br></span></h2>
