            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                    <div style="text-align:center;">
                        <h2 class="divider-style" style="margin-top: -1px;"><span>Booking Management<br></span></h2>
                    </div>
                    <div class="card">
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Confirm or Decline Booking Request</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Approval Booking or decline</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" onclick="window.location.href = 'ConfirmOrDeclineBookingRequest.jsp';"><strong>Go</strong><br></button>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Check-in Booking</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Check-in Bookin</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" onclick="window.location.href = 'CheckInBooking.jsp';"><strong>Go</strong><br></button>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Check-out Booking</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Check-out Booking</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" onclick="window.location.href = 'CheckoutBooking.jsp';"><strong>Go</strong><br></button>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Block member to use booking function</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>block</strong></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" onclick="window.location.href = 'BlockMemberUseBookingFunction.jsp';"><strong>Go</strong><br></button>
                        </div>
                    </div>
                </div>
            </div>
