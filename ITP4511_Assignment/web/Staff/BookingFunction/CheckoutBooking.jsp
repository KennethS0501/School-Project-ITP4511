    ...
    <tr>
      ...
      <td>Luxemburg</td>
		...
		<td>Approve</td>
                    ...
                    <form><input class="form-control" type="text" style="width: 291px;" placeholder="ID"><input class="form-control" type="text" style="width: 291px;margin-top: 6px;" placeholder="Remark"><button class="btn btn-primary" type="button" style="margin-top: 10px;">Check-out</button></form>
                </div>
            </div>
        </div>
    </div>
