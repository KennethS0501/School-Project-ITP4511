  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Luxemburg</td>
                    ...
                    <form><input class="form-control" type="text" style="width: 200px;" placeholder="ID"><button class="btn btn-primary" type="button" style="margin-top: 10px;">Block</button><button class="btn btn-primary" type="button" style="margin-top: 10px;">Unblock</button></form>
                </div>
            </div>
        </div>
    </div>
