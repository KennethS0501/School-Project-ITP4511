    ...
    <tr>
      ...
      <td>Luxemburg</td>
		...
		<td>Approve</td>
                    ...
                    <form><input class="form-control" type="text" style="width: 200px;" placeholder="ID"><button class="btn btn-primary" type="button" style="margin-top: 10px;">Check-in</button></form>
                </div>
            </div>
        </div>
    </div>
