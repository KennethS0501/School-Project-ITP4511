        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-xl-3">
                    <div class="row">
                        <div class="col-lg-4 col-xl-9" style="margin-left: 0px;">
                ...
                <div class="col-md-4 col-xl-9" style="padding-left: 43px;">
                    <div style="text-align:center;">
                        <h2 class="divider-style" style="margin-top: -1px;"><span>Enable Or Disable Venue<br></span></h2>
    ...
    <tr>
      ...
      <td>Luxemburg</td>
		...
		<td>Eger</td>
                    ...
                    <form><input class="form-control" type="text" style="width: 200px;" placeholder="Id"></form>
                    <form>
                        <div class="field"><select class="form-control" style="margin: 0px;margin-top: 8px;width: 201px;"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select></div>
                    </form><button class="btn btn-primary" type="button">Change</button></div>
            </div>
        </div>
    </div>
