                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-9" style="padding-left: 43px;">
                        ...
                        <form method="post" action="EditVenue" enctype="multipart/form-data">
                            <input class="form-control" type="hidden" name="action" value="EnableOrDisable" style="width: 200px;" placeholder="Id"/>
                            <input class="form-control" type="text" name="VauneId" style="width: 200px;" placeholder="Id"/>
                            <div class="field">
                                <select class="form-control" name="status" style="margin: 0px;margin-top: 8px;width: 201px;">
                                    <optgroup label="Select Enable or disable" >
