            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                    <div style="text-align:center;">
                        <h2 class="divider-style" style="margin-top: -1px;"><span>Edit Venue<br></span></h2><div class="form-group pull-right">
    ...
    <tr>
      ...
      <td>Luxemburg</td>
		...
		<td>Eger</td>
                    ...
                    <form><input class="form-control" type="text" style="width: 200px;" placeholder="Id"><input class="form-control" type="number" placeholder="Name" style="margin-top: 10px;width: 200px;"><input class="form-control" type="number" placeholder="Type"
                            style="margin-top: 10px;width: 200px;"><label>Image:&nbsp;&nbsp;</label><input type="file" style="margin-top: 9px;"><input class="form-control" type="number" placeholder="Capacity" style="margin-top: 10px;width: 200px;">
                        <input
                            class="form-control" type="number" placeholder="Location" style="margin-top: 10px;width: 200px;"><input class="form-control" type="number" placeholder="Description" style="margin-top: 10px;width: 200px;"><input class="form-control" type="number" placeholder="Person-in-charge" style="margin-top: 10px;width: 200px;"><input class="form-control"
                                type="number" placeholder="Booking Fee" style="margin-top: 10px;width: 200px;"><button class="btn btn-primary" type="button" style="margin-top: 10px;">Edit</button></form>
                </div>
            </div>
        </div>
    </div>
