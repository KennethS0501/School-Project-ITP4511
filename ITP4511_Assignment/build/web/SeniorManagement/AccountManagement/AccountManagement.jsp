                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span>Account Management<br></span></h2>
                        </div>
                        <div class="card">
                            <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                                <h4 class="card-title"><strong>Account List</strong><br></h4>
                                <h6 class="text-muted card-subtitle mb-2"><strong>Account List</strong><br></h6>
                                <ul class="list-group"></ul>
                                <button class="btn btn-primary" onclick="window.location.href = 'AccountList.jsp';"><strong>Go</strong><br></button>
                            </div>
                            <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                                <h4 class="card-title"><strong>Create Account</strong><br></h4>
                                <h6 class="text-muted card-subtitle mb-2"><strong>Create Account</strong><br></h6>
                                <ul class="list-group"></ul>
                                <button class="btn btn-primary" onclick="window.location.href = 'CreateAccount.jsp';"><strong>Go</strong><br></button>
                            </div>
                            <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                                <h4 class="card-title"><strong>Edit Account</strong><br></h4>
                                <h6 class="text-muted card-subtitle mb-2"><strong>Edit account role and detail</strong><br></h6>
                                <ul class="list-group"></ul>
                                <button class="btn btn-primary" onclick="window.location.href = 'EditAccount.jsp';"><strong>Go</strong><br></button>
                            </div>
                            <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                                <h4 class="card-title"><strong>Delete Account</strong><br></h4>
                                <h6 class="text-muted card-subtitle mb-2"><strong>Delete Account</strong><br></h6>
                                <ul class="list-group"></ul>
                                <button class="btn btn-primary" onclick="window.location.href = 'DeleteAccount.jsp';"><strong>Go</strong><br></button>
                            </div>
                        </div>
                    </div>
                </div>
