                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xl-12" style="margin-left: 99px;">
                            <div class="list-group">
                                    ...
                                    <a class="list-group-item list-group-item-action" data-toggle="list" onclick="window.location.href = 'RoleManagement.jsp';" style="width: 250px;">Role Management</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                    <div style="text-align:center;">
                        <h2 class="divider-style" style="margin-top: -1px;"><span>Role Management<br></span></h2>
                    </div>
                    <div class="card">
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Add Role</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Add Role</strong><br></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" onclick="window.location.href = 'AddRole.jsp';"><strong>Go</strong><br></button></form>
                        </div>
                        <div class="card-body" style="margin-top: 10px;border-style: solid;border-color: #dfe8ee;">
                            <h4 class="card-title"><strong>Delete Role</strong><br></h4>
                            <h6 class="text-muted card-subtitle mb-2"><strong>Delete Role</strong><br></h6>
                            <ul class="list-group"></ul>
                            <button class="btn btn-primary" onclick="window.location.href = 'DeleteRole.jsp';"><strong>Go</strong><br>
                        </div>
                    </div>
                </div>
            </div>
