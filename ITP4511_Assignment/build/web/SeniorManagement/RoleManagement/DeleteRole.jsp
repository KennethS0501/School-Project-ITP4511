                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span>Delete Role<br></span></h2>
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <role:showRole tagType="table" />
                            </tbody>
                        </table>
                        <form action="Role" method="post">
                            <input class="form-control" type="number" min="0" style="width: 200px;" placeholder="Id" name="id">
