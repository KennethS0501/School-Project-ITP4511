        ...
        <div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-8" style="padding-left: 43px;height: 574px;">
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <bookingRecords:showBookingRecord tagType="showBookingRecordByTableByVenue" venueId="${param.venueId}" />
                            </tbody>
                        </table>
                    </div>
                </div>
