                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span>Income Generated<br></span></h2>
                        </div>
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <bookingRecords:showBookingRecord tagType="getIncomeByEachVenue" radio="${param.radio}" year="${param.year}" month="${param.month}" />
                            </tbody>
                        </table></div>
                </div>
            </div>
