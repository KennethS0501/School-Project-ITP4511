            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-8" style="padding-left: 43px;">
                        ...
                        <label>Total Booking: <bookingRecords:showBookingRecord tagType="showVenueBookingNumber" venueId="${param.venueId}"/></label><br/>
                        <label>The time range booking: <bookingRecords:showBookingRecord tagType="showBookingNumberByTimeRange" venueId="${param.venueId}" radio="${param.radio}" year="${param.year}" month="${param.month}" /></label><br/>
                        
                        <label>Booking Rate: <bookingRecords:showBookingRecord tagType="showBookingRate" venueId="${param.venueId}" radio="${param.radio}" year="${param.year}" month="${param.month}" /> </label>
...
<!--                                <tr class="warning no-result">
                            ...
                            <tbody>
                                <bookingRecords:showBookingRecord tagType="showBookingRecordByTimeRange" venueId="${param.venueId}" radio="${param.radio}" year="${param.year}" month="${param.month}" />
                            </tbody>
                        </table>
                    </div>
                </div>
