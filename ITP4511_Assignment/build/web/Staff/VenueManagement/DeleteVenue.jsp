            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xl-3">
                        <div class="row">
                            <div class="col-lg-4 col-xl-12" style="margin-left: -22px;">
                    ...
                    <div class="col-md-4 col-xl-9" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span>Delete Venue<br></span></h2>
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <ict:showVenue tagType="showVenueWithDelete"/>
                            </tbody>
                        </table></div>
                </div>
            </div>
