                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-9" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span><strong>Check-in Booking</strong><br></span></h2>
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <ict:showBookOrder tagType="CheckIn"/>
                            </tbody>
                        </table>
...
<!--                             <input class="form-control" name="Remark" type="text" style="margin-top:8px;width: 200px;" placeholder="remark">-->
                            <button class="btn btn-primary" type="submit" style="margin-top: 10px;">Check-in</button>
                        </form>
                    </div>
                </div>
            </div>
