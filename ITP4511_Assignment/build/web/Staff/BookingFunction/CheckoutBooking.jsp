                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-9" style="padding-left: 43px;">
                        <div style="text-align:center;">
                            <h2 class="divider-style" style="margin-top: -1px;"><span><strong>Check-out Booking</strong><br></span></h2>
                        ...
                        <table class="table table-hover table-bordered results">
                            ...
                            <tbody>
                                <ict:showBookOrder tagType="CheckOut"/>
                            </tbody>
                        </table>
                        <form method="post" action="EditBookingOrder">
                            ...
                            <input class="form-control" type="number" name="OrderId" style="width: 291px;" placeholder="ID">
                            <input class="form-control" type="text"  name="Remark" style="width: 291px;margin-top: 6px;" placeholder="Remark">
                            <button class="btn btn-primary" type="submit" style="margin-top: 10px;">Check-out</button>
                        </form>
                    </div>
                </div>
            </div>
